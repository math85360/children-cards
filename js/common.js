...
import { useEffect, useState, useReducer, useRef, useCallback } from 'https://unpkg.com/preact@latest/hooks/dist/hooks.module.js?module'
...
function useLocalStorage(keyname, reducer, initialState) {
    const [state, dispatch] = useReducer(reducer, JSON.parse(window.localStorage.getItem(keyname)) || initialState)
